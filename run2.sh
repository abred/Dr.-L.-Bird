...
cp -r  ~/Application\ Cache /scratch/s7550245/chromiums/chromium$3/Default
...
cp -r /home/s7550245/abV1.32/plugin /scratch/s7550245/chromiums/chromium$3
...
/sw/global/tools/java/jdk1.8.0_66/bin/java -jar ~/Dr.-L.-Bird2/ABServer.jar -s $portS -c $portC
